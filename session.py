...
class SessionManager(object):
    ...
    def get(self, session_id = None, hmac_digest = None):
        ...
        if session_id == None:
            ...
            session_id = bytes(self._generate_uid() , 'latin-1')
    ...
    def _get_hmac_digest(self, session_id):
        return hmac.new(session_id , self.secret.encode("utf8"), hashlib.sha1).hexdigest()
               
    def _generate_uid(self):
        base = hashlib.md5( (self.secret + str(uuid.uuid4())).encode("utf8") )
